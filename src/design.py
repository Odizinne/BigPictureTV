...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gamemode_video_label = QtWidgets.QLabel(parent=self.gridFrame)
        self.gamemode_video_label.setMinimumSize(QtCore.QSize(0, 25))
        self.gamemode_video_label.setObjectName("gamemode_video_label")
        self.gridLayout_3.addWidget(self.gamemode_video_label, 0, 0, 1, 1)
        self.gamemode_video_combobox = QtWidgets.QComboBox(parent=self.gridFrame)
        self.gamemode_video_combobox.setMinimumSize(QtCore.QSize(0, 25))
        self.gamemode_video_combobox.setFrame(False)
        self.gamemode_video_combobox.setObjectName("gamemode_video_combobox")
        self.gridLayout_3.addWidget(self.gamemode_video_combobox, 0, 2, 1, 1)
        ...
        self.desktop_video_combobox = QtWidgets.QComboBox(parent=self.gridFrame)
        self.desktop_video_combobox.setMinimumSize(QtCore.QSize(0, 25))
        self.desktop_video_combobox.setObjectName("desktop_video_combobox")
        self.gridLayout_3.addWidget(self.desktop_video_combobox, 1, 2, 1, 1)
        self.gridLayout_2.addWidget(self.gridFrame, 5, 0, 1, 1)
        ...
        self.gridLayout_5.addWidget(self.checkRateSpinBox, 2, 2, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_3.setText(_translate("MainWindow", "Video output configuration"))
        self.gamemodeLabel.setText(_translate("MainWindow", "Gamemode"))
        self.desktopLabel.setText(_translate("MainWindow", "Desktop"))
        self.gamemode_video_label.setText(_translate("MainWindow", "Gamemode screen"))
        self.label.setText(_translate("MainWindow", "Desktop screen"))
